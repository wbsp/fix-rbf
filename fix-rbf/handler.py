...
def handle(request):
    try:
        ...
        #img = 'https://pbs.twimg.com/profile_images/348222205/TwitterProfilePic_400x400.jpg'
        ...
        # Your PixLab API key
        key = "237fe9c1db15dafeb57a2f0036896f1c"
        ...
        if reply['status'] != 200:
            ...
            r = requests.get(reply['link'], allow_redirects=True)
        ...
        msg = "exception while processing image={0} cwd:{1} -- Exception: type={2}; args={3}; traceback={4}; paths={5}".format(img, os.getcwd(), type(inst), inst.args, traceback.format_exc())
